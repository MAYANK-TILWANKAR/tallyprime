...
const Hero = () => {
  return (
    <section className="relative sm:h-screen h-[700px] w-full flex items-center overflow-hidden">
      <div className="container mx-auto px-4 z-10">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="w-full md:w-1/2 mx-auto md:mx-[42rem]">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight text-center md:text-left">
          ...
          <motion.h2
            ...
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white mt-3 sm:mt-4 mb-4 sm:mb-6 text-center md:text-left">
