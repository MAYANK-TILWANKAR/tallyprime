...
export const metadata = {
  ...
  authors: [{ name: "ICA Global Academy" }],
  openGraph: {
    title: "TallyPrime Course | Learn Accounting Software | ICA Global Academy",
    description:
      "Master TallyPrime with GST in 3 months. 100% job placement support. Comprehensive accounting software course by ICA Global Academy. Enroll now!",
    ...
    images: [{ url: "/images/tallyprime-course-og.jpg" }],
  },
  twitter: {
    ...
    description:
      "Master TallyPrime with GST in 3 months. 100% job placement support. Comprehensive accounting software course by ICA Global Academy. Enroll now!",
    images: ["/images/tallyprime-course-twitter.jpg"],
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Master TallyPrime with GST in 3 months. 100% job placement support.",
              provider: {
                "@type": "Organization",
